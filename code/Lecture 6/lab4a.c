...
int main(int argc,char *argv[])
	...
	int bytes_sent;
	int byte_received;
        char *msg ="Hello I am Client Aditi";
        int client;
	if (argc!=2)
	{
...
//listen()  marks  the  socket referred to by sockfd as a passive socket,that is, as socket that will be used to  accept  incoming  connection requests using accept.
//accept()  It  extracts  the  first   connection request  on  the queue of pending connections for the listening socket
